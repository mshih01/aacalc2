...
export { getSubArmies } from './external.js';
...
export type { WaveInput } from './external.js';
export type { UnitIdentifier } from './external.js';
export type { Army } from './external.js';
export type { UnitGroup } from './external.js';
